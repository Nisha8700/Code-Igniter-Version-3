...
<html lang="en">
    ...
    <body>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url('dashboard')?>"><span>Test Admin Panel</span></a>
        ...
        <footer>
            ...
            <p> <center>
                <span>&copy; <?php echo date("Y"); ?> Test CodeIgniter - Bootstrap Template By <a href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" style="color:white;" alt="Bootstrap_Metro_Dashboard">Bootstrap Metro Dashboard</a></span>
